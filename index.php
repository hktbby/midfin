...
<body>
      ...
      <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                ...
                <!--      <img src="images/logo.jpg"  width="15% "/> --> HKT PET SHOPPEE</h4></a>
                </div>
        ...
        <div class="col-md-9 wow fadeInDown">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="background-color:#000; padding:10px;">
              ...
              <div class="">
                ...
                <div class="">
                  <img src="images/last.png" alt="" class="">
                </div>
...
<!--*********************************************Food PACKAGES************************************************-->
        ...
        <div class="col-md-3" >
            <div class="panel panel-default wow fadeInDown">
              ...
              <div class="panel-heading wow fadeInDown" style="font-weight:bold; font-size:16px; color:#36648B;">Welcome To HKT PET SHOPPEE<i class="glyphicon glyphicon-calendar"></i> <?php echo date('M d, Y');?></div>
...
<footer id="footer" class="midnight-blue wow fadeInDown">
        <div class="container">
            <div class="row">
               ...
               &copy; 2024 <a target="_blank" href="#" title="#">PET SHOPPEE</a>. All Rights Reserved.
                </div>
                <div class="col-sm-6">
